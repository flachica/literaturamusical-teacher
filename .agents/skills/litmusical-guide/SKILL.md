...
- **v0.3.1:** Iteración de Usabilidad: Optimización del Modo Detective Guiado (Visualizador de ondas, scroll y tipografías infantiles) + Corrección de error 403 en descargas de listas de reproducción. [COMPLETADO CON ÉXITO - SESIÓN 7]
...
- **v0.4.1:** Refinamiento de Gamificación y Rediseño de Flujo (MochilaModal colapsable, Wizard dinámico sustitutivo de retos, contención de scroll a 560px, navegación atrás y limpieza de recordatorios de verso sueltos). [COMPLETADO CON ÉXITO - SESIÓN 8 / ACTUAL]
- **v0.4.2:** Refactorización de Componentes Extensos (Dividir y modularizar `ModoDetectiveGuiado.jsx` en subcomponentes pequeños y simplificar `SongManager.jsx`). [PLANIFICADO / SIGUIENTE PASO]
